...
void HistPrinter::PrintPage(vector<TH1 *> &HistoList, const std::string &PageTitle, TCanvas *myText, char fileName[100], TLatex titles, TLatex text, const std::string &Constraint1,
    ...
    if (PageTitle == "Manual Veto Plots") {
        ...
        if (Constraint1 == "") {
            text.DrawLatex(0.10, 0.6, ("#bullet  " + basic_tools::ToStringWithPrecision(Num_of_e_cut, 0) + " electron").c_str());
            text.DrawLatex(0.10, 0.5, ("#bullet  " + basic_tools::ToStringWithPrecision(Num_of_p_cut, 0) + " proton in CD or FD").c_str());
            ...
            text.DrawLatex(0.10, 0.6, ("#bullet  " + basic_tools::ToStringWithPrecision(Num_of_e_cut, 0) + " electron").c_str());
            text.DrawLatex(0.10, 0.5, ("#bullet  " + basic_tools::ToStringWithPrecision(Num_of_p_cut, 0) + " proton in CD").c_str());
            text.DrawLatex(0.10, 0.4, "#bullet  Any number of neutrons in CND");
            text.DrawLatex(0.10, 0.3, "#bullet  Only particles with pdg=2112,11,2212,0,22 in event");
        } else if (Constraint1 == "FD") {
            text.DrawLatex(0.10, 0.6, ("#bullet  " + basic_tools::ToStringWithPrecision(Num_of_e_cut, 0) + " electron").c_str());
            text.DrawLatex(0.10, 0.5, ("#bullet  " + basic_tools::ToStringWithPrecision(Num_of_p_cut, 0) + " proton in FD").c_str());
            text.DrawLatex(0.10, 0.4, "#bullet  Any number of neutrons in CND");
            text.DrawLatex(0.10, 0.3, "#bullet  Only particles with pdg=2112,11,2212,0,22 in event");
        }
        ...
        text.DrawLatex(0.10, 0.7, ("#bullet  #font[12]{#theta_{n,miss} #leq " + basic_tools::ToStringWithPrecision(GN_theta_n_miss_ucut, 0) + "#circ}, and").c_str());
        text.DrawLatex(0.10, 0.6,
                       ("#bullet  #font[12]{" + basic_tools::ToStringWithPrecision(GN_dpp_lcut, 1) + " #leq #left(#lbar#font[62]{P}_{miss}#lbar - #lbar#font[62]{P}_{n}#lbar#right)/P_{miss} #leq " +
                        basic_tools::ToStringWithPrecision(GN_dpp_ucut, 1) + "}")
                           .c_str());
        ...
        text.DrawLatex(0.10, 0.7, ("#bullet  #font[12]{#lbar#beta_{n} - L/(t_{ToF,n}c)#lbar #leq " + basic_tools::ToStringWithPrecision(dBeta_n_cut) + "}").c_str());
        text.DrawLatex(0.10, 0.6, ("#bullet  #font[12]{" + basic_tools::ToStringWithPrecision(Vz_n_lcut) + " #leq V_{hit,z} #leq " + basic_tools::ToStringWithPrecision(Vz_n_ucut) + "} cm").c_str());
        text.DrawLatex(0.10, 0.5, ("#bullet  #font[12]{" + basic_tools::ToStringWithPrecision(ToF_n_lcut) + " #leq t_{ToF,n} #leq " + basic_tools::ToStringWithPrecision(ToF_n_ucut) + "} ns").c_str());
        ...
        text.DrawLatex(0.10, 0.3, ("#bullet  #font[12]{" + basic_tools::ToStringWithPrecision(Edep_CND_lcut, 0) + " #leq E_{dep}^{CND} #leq (#gamma_{n} - 1) m_{n}} MeV").c_str());
        ...
        text.DrawLatex(0.10, 0.3, ("#bullet  Cluster size (= width) is " + basic_tools::ToStringWithPrecision(Cluster_size_cut, 0) + " hit").c_str());
        text.DrawLatex(0.10, 0.25, "#bullet  Layer multiplicity:");
        text.DrawLatex(0.15, 0.2, ("#Box  Hit in CND1 #rightarrow layer multiplicity = " + basic_tools::ToStringWithPrecision(CND1_LayerMult_cut, 0)).c_str());
        text.DrawLatex(0.15, 0.15, ("#Box  Hit in CND2 or CND3 #rightarrow layer multiplicity = up to " + basic_tools::ToStringWithPrecision(CND2andCND3_LayerMult_ucut, 0)).c_str());
...
void HistPrinter::SummaryTablePlotter(int n_col, int n_row, TCanvas *myCanvas, TCanvas *myText, TCanvas *myTable, vector<TH1 *> HistoList, TLatex titles, TLatex text, char fileName[100],
    ...
    if (Constraint1 == "" || Constraint1 == "CD") {
        ...
        TH2F frame1_epCDn("frame1_epCDn", "", summary_table_title.size(), 0, summary_table_title.size(), table_epCDn.size(), 0, table_epCDn.size());
        ...
        TPave row1(0, (table_epCDn.size() - 1), summary_table_title.size(), table_epCDn.size(), 0, "br");  // Row 1 (top row)
        ...
        for (int i = 0; i < table_epCDn.size(); i++) {
            ...
            if ((!basic_tools::FindSubstring(cellTemp, "}{(Step") && !basic_tools::FindSubstring(cellTemp, "}{cuts")) && (i > 0)) {
                TPave row(0, (table_epCDn.size() - i - 1), summary_table_title.size(), (table_epCDn.size() - i), 0, "br");
        ...
        for (int i = 0; i <= table_epCDn.size(); i++) {
            // Horizontal lines
            TLine line_epCDn(0, i, summary_table_title.size(), i);
            line_epCDn.SetLineStyle(2);
            line_epCDn.Draw();
        }
        for (int j = 0; j <= summary_table_title.size(); j++) {
            // Vertical lines
            TLine line_epCDn(j, 0, j, table_epCDn.size());
            line_epCDn.SetLineStyle(2);
            line_epCDn.Draw();
        }
        ...
        TH2F frame2_epCDn("frame2_epCDn", "", summary_table_title.size(), 0, summary_table_title.size(), table2_epCDn.size(), 0, table2_epCDn.size());
        ...
        TPave row2(0, (table2_epCDn.size() - 1), summary_table_title.size(), table2_epCDn.size(), 0, "br");  // Row 1 (top row)
        ...
        for (int i = 0; i < table2_epCDn.size(); i++) {
            ...
            if ((!basic_tools::FindSubstring(cellTemp, "}{(Step") && !basic_tools::FindSubstring(cellTemp, "}{cuts")) && (i > 0)) {
                TPave row(0, (table2_epCDn.size() - i - 1), summary_table_title.size(), (table2_epCDn.size() - i), 0, "br");
                row.SetFillColor(kAzure - 9);
                row.SetFillStyle(1001);
                row.SetLineColor(0);
                row.Draw();
        ...
        for (int j = 0; j <= summary_table_title.size(); j++) {
            // Vertical lines
            TLine line_epCDn(j, 0, j, table2_epCDn.size());
            line_epCDn.SetLineStyle(2);
            line_epCDn.Draw();
        }
        ...
        TH2F frame3_epCDn("frame3_epCDn", "", summary_table_title.size(), 0, summary_table_title.size(), table3_epCDn.size(), 0, table3_epCDn.size());
        ...
        TPave row3(0, (table3_epCDn.size() - 1), summary_table_title.size(), table3_epCDn.size(), 0, "br");  // Row 1 (top row)
        ...
        for (int i = 0; i < table3_epCDn.size(); i++) {
            ...
            if ((!basic_tools::FindSubstring(cellTemp, "}{(Step") && !basic_tools::FindSubstring(cellTemp, "}{cuts")) && (i > 0)) {
                TPave row(0, (table3_epCDn.size() - i - 1), summary_table_title.size(), (table3_epCDn.size() - i), 0, "br");
                row.SetFillColor(kAzure - 9);
                row.SetFillStyle(1001);
                row.SetLineColor(0);
                row.Draw();
        ...
        for (int j = 0; j <= summary_table_title.size(); j++) {
            // Vertical lines
            TLine line_epCDn(j, 0, j, table3_epCDn.size());
            line_epCDn.SetLineStyle(2);
            line_epCDn.Draw();
        }
