...
unset DIR_MnCDV_CODE
# setenv DIR_MnCDV_CODE $(pwd)
setenv DIR_MnCDV_CODE `pwd`
# setenv DIR_MnCDV_CODE /w/hallb-scshelf2102/clas12/asportes/2N-Analyzer
echo "${COLOR_START}DIR_MnCDV_CODE:${COLOR_END} ${DIR_MnCDV_CODE}"
echo ""
