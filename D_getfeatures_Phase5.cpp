...
#pragma region /* Andrew's histograms - start */
    ...
    TH1D *h_P_n_x_minus_P_miss_x_A = new TH1D("P_n_x_minus_P_miss_x", "P_{x,n}-P_{x,miss} Distribution; P_{x,n}-P_{x,miss} [GeV/c];Counts", 50, -1.5, 1.5);
    hist_list_1_A.push_back(h_P_n_x_minus_P_miss_x_A);
    TH1D *h_P_n_y_minus_P_miss_y_A = new TH1D("P_n_y_minus_P_miss_y", "P_{y,n}-P_{y,miss} Distribution; P_{y,n}-P_{y,miss} [GeV/c];Counts", 50, -1.5, 1.5);
    hist_list_1_A.push_back(h_P_n_y_minus_P_miss_y_A);
    TH1D *h_P_n_z_minus_P_miss_z_A = new TH1D("P_n_z_minus_P_miss_z", "P_{z,n}-P_{z,miss} Distribution; P_{z,n}-P_{z,miss} [GeV/c];Counts", 50, -1.5, 1.5);
    ...
    TH2D *h_P_n_x_VS_P_miss_x_A = new TH2D("P_n_x_VS_P_miss_x", "P_{x,n} vs P_{x,miss} Distribution;P_{x,n} [GeV/c];P_{x,miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    hist_list_1_A.push_back(h_P_n_x_VS_P_miss_x_A);
    TH2D *h_P_n_y_VS_P_miss_y_A = new TH2D("P_n_y_VS_P_miss_y", "P_{y,n} vs P_{y,miss} Distribution;P_{y,n} [GeV/c];P_{y,miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    hist_list_1_A.push_back(h_P_n_y_VS_P_miss_y_A);
    TH2D *h_P_n_z_VS_P_miss_z_A = new TH2D("P_n_z_VS_P_miss_z", "P_{z,n} vs P_{z,miss} Distribution;P_{z,n} [GeV/c];P_{z,miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
