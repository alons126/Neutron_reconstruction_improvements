...
#pragma region /* Andrew's histograms - start */
    ...
    TH1D *h_n_multiplicity_allN_epnFD = new TH1D("n_multiplicity_allN_epnFD", "Number of Neutrons in Event", 10, 0, 10);
    hist_list_1.push_back(h_n_multiplicity_allN_epnFD);
    TH1D *h_n_multiplicity_goodN_epnFD = new TH1D("n_multiplicity_goodN_epnFD", "Number of Neutrons in Event", 10, 0, 10);
    hist_list_1.push_back(h_n_multiplicity_goodN_epnFD);
    TH1D *h_n_multiplicity_badN_epnFD = new TH1D("n_multiplicity_badN_epnFD", "Number of Neutrons in Event", 10, 0, 10);
    hist_list_1.push_back(h_n_multiplicity_badN_epnFD);
...
— TH2D *h_M_miss_VS_P_n_epnFD = new TH2D("M_miss_VS_P_n_epnFD", "Missing Mass vs Measured Neutron Momentum;P_{n} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0.25, 1., 50, 0, 1.5);
    ...
    TH1D *h_P_n_minus_P_miss_epnCD = new TH1D("P_n_minus_P_miss_epnCD", "P_{n}-P_{miss} [GeV/c];P_{n}-P_{miss} [GeV/c];Counts", 50, -1.5, 1.5);
    ...
    TH2D *h_P_n_VS_P_miss_epnFD = new TH2D("P_n_VS_P_miss_epnFD", "P_{n} vs P_{miss} [GeV/c];P_{n} [GeV/c];P_{miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    ...
    TH1D *h_P_n_minus_P_miss_epnFD = new TH1D("P_n_minus_P_miss_epnFD", "P_{n}-P_{miss} [GeV/c];P_{n}-P_{miss} [GeV/c];Counts", 50, -1.5, 1.5);
    ...
    TH2D *h_P_n_VS_P_miss_epnCD = new TH2D("P_n_VS_P_miss_epnCD", "P_{n} vs P_{miss} [GeV/c];P_{n} [GeV/c];P_{miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    ...
    TH2D *h_theta_P_n_P_p_epnCD = new TH2D("theta_P_n_P_p_epnCD", "#theta_{p,n} vs P_{p};P_{p} [GeV/c];#theta_{p,n} [#circ]", 50, 0, 1.5, 50, 0, 180);
    hist_list_2_A.push_back(h_theta_P_n_P_p_epnCD);

    TH2D *h_theta_P_n_P_p_epnFD = new TH2D("theta_P_n_P_p_epnFD", "#theta_{p,n} vs P_{p};P_{p} [GeV/c];#theta_{p,n} [#circ]", 50, 0, 1.5, 50, 0, 180);
    hist_list_2_A.push_back(h_theta_P_n_P_p_epnFD);
    ...
    /* Detector responses */
    TH1D *h_Edep_CND_epnCD = new TH1D("Edep_CND_epnCD", "Neutron Energy Deposition in the CND;Energy [MeV];Counts", 50, 0, 100);
    hist_list_1_A.push_back(h_Edep_CND_epnCD);
    TH2D *h_P_n_VS_Edep_CND_epnCD = new TH2D("P_n_VS_Edep_CND_epnCD", "Neutron Momentum vs Neutron Energy Deposition in the CND;E_{dep} [MeV];P_{n} [GeV/c]", 50, 0, 100, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_n_VS_Edep_CND_epnCD);
    TH2D *h_theta_n_VS_Edep_CND_epnCD = new TH2D("theta_n_VS_Edep_CND_epnCD", "#theta_{n} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];#theta_{n} [#circ]", 50, 0, 100, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_VS_Edep_CND_epnCD);
    TH2D *h_phi_n_VS_Edep_CND_epnCD = new TH2D("phi_n_VS_Edep_CND_epnCD", "#phi_{n} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];#phi_{n} [#circ]", 50, 0, 100, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_n_VS_Edep_CND_epnCD);
    TH2D *h_P_miss_VS_Edep_CND_epnCD = new TH2D("P_miss_VS_Edep_CND_epnCD", "Missing Momentum vs Neutron Energy Deposition in the CND;E_{dep} [MeV];P_{miss} [GeV/c]", 50, 0, 100, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_miss_VS_Edep_CND_epnCD);
    TH2D *h_theta_miss_VS_Edep_CND_epnCD = new TH2D("theta_miss_VS_Edep_CND_epnCD", "#theta_{miss} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];#theta_{miss} [#circ]", 50, 0, 100, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_miss_VS_Edep_CND_epnCD);
    TH2D *h_phi_miss_VS_Edep_CND_epnCD = new TH2D("phi_miss_VS_Edep_CND_epnCD", "#phi_{miss} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];#phi_{miss} [#circ]", 50, 0, 100, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_miss_VS_Edep_CND_epnCD);
    TH2D *h_dpp_VS_Edep_CND_epnCD = new TH2D("dpp_VS_Edep_CND_epnCD", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_CND_epnCD);
    TH2D *h_beta_n_VS_Edep_CND_epnCD = new TH2D("beta_n_VS_Edep_CND_epnCD", "#beta_{n} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];#beta_{n}", 50, 0, 100, 50, -0.1, 1.1);
    hist_list_2_A.push_back(h_beta_n_VS_Edep_CND_epnCD);
    TH2D *h_E_miss_VS_Edep_CND_epnCD = new TH2D("E_miss_VS_Edep_CND_epnCD", "E_{miss} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];E_{miss} [GeV]", 50, 0, 100, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_E_miss_VS_Edep_CND_epnCD);
    TH2D *h_M_miss_VS_Edep_CND_epnCD = new TH2D("M_miss_VS_Edep_CND_epnCD", "M_{miss} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];M_{miss} [GeV/c^{2}]", 50, 0, 100, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_M_miss_VS_Edep_CND_epnCD);
    TH2D *h_path_VS_Edep_CND_epnCD = new TH2D("path_VS_Edep_CND_epnCD", "Path length vs Neutron Energy Deposition in the CND;E_{dep} [MeV];Path length [cm]", 50, 0, 100, 50, 0., 100.);
    hist_list_2_A.push_back(h_path_VS_Edep_CND_epnCD);
    TH2D *h_theta_n_miss_VS_Edep_CND_epnCD = new TH2D("theta_n_miss_VS_Edep_CND_epnCD", "#theta_{n,miss} vs Neutron Energy Deposition in the CND;E_{dep} [MeV];#theta_{n,miss} [#circ]", 50, 0, 100, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_miss_VS_Edep_CND_epnCD);
    TH2D *h_ToF_VS_Edep_CND_epnCD = new TH2D("ToF_VS_Edep_CND_epnCD", "Neutron ToF vs Neutron Energy Deposition in the CND;E_{dep} [MeV];ToF [ns]", 50, 0, 100, 50, 0., 20.);
    hist_list_2_A.push_back(h_ToF_VS_Edep_CND_epnCD);
    TH2D *h_nSector_VS_Edep_CND_epnCD = new TH2D("nSector_VS_Edep_CND_epnCD", "Neutron Sector Number vs Neutron Energy Deposition in the CND;E_{dep} [MeV];Sector Number", 50, 0, 100, 24, 0., 24.);
    hist_list_2_A.push_back(h_nSector_VS_Edep_CND_epnCD);

    TH1D *h_Edep_CND_epnFD = new TH1D("Edep_CND_epnFD", "Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];Counts", 50, 0, 100);
    hist_list_1_A.push_back(h_Edep_CND_epnFD);
    TH2D *h_P_n_VS_Edep_CND_epnFD = new TH2D("P_n_VS_Edep_CND_epnFD", "Neutron Momentum vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];P_{n} [GeV/c]", 50, 0, 100, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_n_VS_Edep_CND_epnFD);
    TH2D *h_theta_n_VS_Edep_CND_epnFD = new TH2D("theta_n_VS_Edep_CND_epnFD", "#theta_{n} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];#theta_{n} [#circ]", 50, 0, 100, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_VS_Edep_CND_epnFD);
    TH2D *h_phi_n_VS_Edep_CND_epnFD = new TH2D("phi_n_VS_Edep_CND_epnFD", "#phi_{n} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];#phi_{n} [#circ]", 50, 0, 100, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_n_VS_Edep_CND_epnFD);
    TH2D *h_P_miss_VS_Edep_CND_epnFD = new TH2D("P_miss_VS_Edep_CND_epnFD", "Missing Momentum vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];P_{miss} [GeV/c]", 50, 0, 100, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_miss_VS_Edep_CND_epnFD);
    TH2D *h_theta_miss_VS_Edep_CND_epnFD = new TH2D("theta_miss_VS_Edep_CND_epnFD", "#theta_{miss} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];#theta_{miss} [#circ]", 50, 0, 100, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_miss_VS_Edep_CND_epnFD);
    TH2D *h_phi_miss_VS_Edep_CND_epnFD = new TH2D("phi_miss_VS_Edep_CND_epnFD", "#phi_{miss} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];#phi_{miss} [#circ]", 50, 0, 100, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_miss_VS_Edep_CND_epnFD);
    TH2D *h_dpp_VS_Edep_CND_epnFD = new TH2D("dpp_VS_Edep_CND_epnFD", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_CND_epnFD);
    TH2D *h_beta_n_VS_Edep_CND_epnFD = new TH2D("beta_n_VS_Edep_CND_epnFD", "#beta_{n} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];#beta_{n}", 50, 0, 100, 50, -0.1, 1.1);
    hist_list_2_A.push_back(h_beta_n_VS_Edep_CND_epnFD);
    TH2D *h_E_miss_VS_Edep_CND_epnFD = new TH2D("E_miss_VS_Edep_CND_epnFD", "E_{miss} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];E_{miss} [GeV]", 50, 0, 100, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_E_miss_VS_Edep_CND_epnFD);
    TH2D *h_M_miss_VS_Edep_CND_epnFD = new TH2D("M_miss_VS_Edep_CND_epnFD", "M_{miss} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];M_{miss} [GeV/c^{2}]", 50, 0, 100, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_M_miss_VS_Edep_CND_epnFD);
    TH2D *h_path_VS_Edep_CND_epnFD = new TH2D("path_VS_Edep_CND_epnFD", "Path length vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];Path length [cm]", 50, 0, 100, 50, 0., 100.);
    hist_list_2_A.push_back(h_path_VS_Edep_CND_epnFD);
    TH2D *h_theta_n_miss_VS_Edep_CND_epnFD = new TH2D("theta_n_miss_VS_Edep_CND_epnFD", "#theta_{n,miss} vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];#theta_{n,miss} [#circ]", 50, 0, 100, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_miss_VS_Edep_CND_epnFD);
    TH2D *h_ToF_VS_Edep_CND_epnFD = new TH2D("ToF_VS_Edep_CND_epnFD", "Neutron ToF vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];ToF [ns]", 50, 0, 100, 50, 0., 20.);
    hist_list_2_A.push_back(h_ToF_VS_Edep_CND_epnFD);
    TH2D *h_nSector_VS_Edep_CND_epnFD = new TH2D("nSector_VS_Edep_CND_epnFD", "Neutron Sector Number vs Neutron Energy Deposition in the CND;E^{CND}_{dep} [MeV];Sector Number", 50, 0, 100, 24, 0., 24.);
    ...
    TH2D *h_P_n_VS_ToF_epnCD = new TH2D("P_n_VS_ToF_epnCD", "Neutron Momentum vs Neutron Energy Deposition in the CTOF;ToF [ns];P_{n} [GeV/c]", 50, 0, 20, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_n_VS_ToF_epnCD);
    TH2D *h_theta_n_VS_ToF_epnCD = new TH2D("theta_n_VS_ToF_epnCD", "#theta_{n} vs Neutron Energy Deposition in the CTOF;ToF [ns];#theta_{n} [#circ]", 50, 0, 20, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_VS_ToF_epnCD);
    TH2D *h_phi_n_VS_ToF_epnCD = new TH2D("phi_n_VS_ToF_epnCD", "#phi_{n} vs Neutron Energy Deposition in the CTOF;ToF [ns];#phi_{n} [#circ]", 50, 0, 20, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_n_VS_ToF_epnCD);
    TH2D *h_P_miss_VS_ToF_epnCD = new TH2D("P_miss_VS_ToF_epnCD", "Missing Momentum vs Neutron Energy Deposition in the CTOF;ToF [ns];P_{miss} [GeV/c]", 50, 0, 20, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_miss_VS_ToF_epnCD);
    TH2D *h_theta_miss_VS_ToF_epnCD = new TH2D("theta_miss_VS_ToF_epnCD", "#theta_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];#theta_{miss} [#circ]", 50, 0, 20, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_miss_VS_ToF_epnCD);
    TH2D *h_phi_miss_VS_ToF_epnCD = new TH2D("phi_miss_VS_ToF_epnCD", "#phi_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];#phi_{miss} [#circ]", 50, 0, 20, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_miss_VS_ToF_epnCD);
    TH2D *h_dpp_VS_ToF_epnCD = new TH2D("dpp_VS_ToF_epnCD", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 20, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_ToF_epnCD);
    TH2D *h_beta_n_VS_ToF_epnCD = new TH2D("beta_n_VS_ToF_epnCD", "#beta_{n} vs Neutron Energy Deposition in the CTOF;ToF [ns];#beta_{n}", 50, 0, 20, 50, -0.1, 1.1);
    hist_list_2_A.push_back(h_beta_n_VS_ToF_epnCD);
    TH2D *h_E_miss_VS_ToF_epnCD = new TH2D("E_miss_VS_ToF_epnCD", "E_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];E_{miss} [GeV]", 50, 0, 20, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_E_miss_VS_ToF_epnCD);
    TH2D *h_M_miss_VS_ToF_epnCD = new TH2D("M_miss_VS_ToF_epnCD", "M_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];M_{miss} [GeV/c^{2}]", 50, 0, 20, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_M_miss_VS_ToF_epnCD);
    TH2D *h_path_VS_ToF_epnCD = new TH2D("path_VS_ToF_epnCD", "Path length vs Neutron Energy Deposition in the CTOF;ToF [ns];Path length [cm]", 50, 0, 20, 50, 0., 100.);
    hist_list_2_A.push_back(h_path_VS_ToF_epnCD);
    TH2D *h_theta_n_miss_VS_ToF_epnCD = new TH2D("theta_n_miss_VS_ToF_epnCD", "#theta_{n,miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];#theta_{n,miss} [#circ]", 50, 0, 20, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_miss_VS_ToF_epnCD);
    TH2D *h_nSector_VS_ToF_epnCD = new TH2D("nSector_VS_ToF_epnCD", "Neutron Sector Number vs Neutron Energy Deposition in the CTOF;ToF [ns];Sector Number", 50, 0, 20, 24, 0., 24.);
    ...
    TH2D *h_P_n_VS_ToF_epnFD = new TH2D("P_n_VS_ToF_epnFD", "Neutron Momentum vs Neutron Energy Deposition in the CTOF;ToF [ns];P_{n} [GeV/c]", 50, 0, 20, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_n_VS_ToF_epnFD);
    TH2D *h_theta_n_VS_ToF_epnFD = new TH2D("theta_n_VS_ToF_epnFD", "#theta_{n} vs Neutron Energy Deposition in the CTOF;ToF [ns];#theta_{n} [#circ]", 50, 0, 20, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_VS_ToF_epnFD);
    TH2D *h_phi_n_VS_ToF_epnFD = new TH2D("phi_n_VS_ToF_epnFD", "#phi_{n} vs Neutron Energy Deposition in the CTOF;ToF [ns];#phi_{n} [#circ]", 50, 0, 20, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_n_VS_ToF_epnFD);
    TH2D *h_P_miss_VS_ToF_epnFD = new TH2D("P_miss_VS_ToF_epnFD", "Missing Momentum vs Neutron Energy Deposition in the CTOF;ToF [ns];P_{miss} [GeV/c]", 50, 0, 20, 50, 0, 1.5);
    hist_list_2_A.push_back(h_P_miss_VS_ToF_epnFD);
    TH2D *h_theta_miss_VS_ToF_epnFD = new TH2D("theta_miss_VS_ToF_epnFD", "#theta_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];#theta_{miss} [#circ]", 50, 0, 20, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_miss_VS_ToF_epnFD);
    TH2D *h_phi_miss_VS_ToF_epnFD = new TH2D("phi_miss_VS_ToF_epnFD", "#phi_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];#phi_{miss} [#circ]", 50, 0, 20, 50, -180., 180.);
    hist_list_2_A.push_back(h_phi_miss_VS_ToF_epnFD);
    TH2D *h_dpp_VS_ToF_epnFD = new TH2D("dpp_VS_ToF_epnFD", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 20, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_ToF_epnFD);
    TH2D *h_beta_n_VS_ToF_epnFD = new TH2D("beta_n_VS_ToF_epnFD", "#beta_{n} vs Neutron Energy Deposition in the CTOF;ToF [ns];#beta_{n}", 50, 0, 20, 50, -0.1, 1.1);
    hist_list_2_A.push_back(h_beta_n_VS_ToF_epnFD);
    TH2D *h_E_miss_VS_ToF_epnFD = new TH2D("E_miss_VS_ToF_epnFD", "E_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];E_{miss} [GeV]", 50, 0, 20, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_E_miss_VS_ToF_epnFD);
    TH2D *h_M_miss_VS_ToF_epnFD = new TH2D("M_miss_VS_ToF_epnFD", "M_{miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];M_{miss} [GeV/c^{2}]", 50, 0, 20, 50, 0.5, 1.5);
    hist_list_2_A.push_back(h_M_miss_VS_ToF_epnFD);
    TH2D *h_path_VS_ToF_epnFD = new TH2D("path_VS_ToF_epnFD", "Path length vs Neutron Energy Deposition in the CTOF;ToF [ns];Path length [cm]", 50, 0, 20, 50, 0., 100.);
    hist_list_2_A.push_back(h_path_VS_ToF_epnFD);
    TH2D *h_theta_n_miss_VS_ToF_epnFD = new TH2D("theta_n_miss_VS_ToF_epnFD", "#theta_{n,miss} vs Neutron Energy Deposition in the CTOF;ToF [ns];#theta_{n,miss} [#circ]", 50, 0, 20, 50, 0., 180.);
    hist_list_2_A.push_back(h_theta_n_miss_VS_ToF_epnFD);
    TH2D *h_nSector_VS_ToF_epnFD = new TH2D("nSector_VS_ToF_epnFD", "Neutron Sector Number vs Neutron Energy Deposition in the CTOF;ToF [ns];Sector Number", 50, 0, 20, 24, 0., 24.);
    ...
    TH2D *h_M_miss_VS_P_miss_goodN_Step0 = new TH2D("M_miss_VS_P_miss_goodN_Step0", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_M_miss_VS_P_miss_badN_Step0 = new TH2D("M_miss_VS_P_miss_badN_Step0", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_goodN_Step0 = new TH2D("dpp_VS_Edep_goodN_Step0", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_badN_Step0 = new TH2D("dpp_VS_Edep_badN_Step0", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_badN_Step0);

    TH2D *h_pnRes_theta_n_miss_Step0 = new TH2D("pnRes_theta_n_miss_Step0", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs. #theta_{n,miss};|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss};#theta_{n,miss} [#circ]", 50, -3.0, 1.0, 90, 0, 180);
    hist_list_2_A.push_back(h_pnRes_theta_n_miss_Step0);
    ...
    TH2D *h_M_miss_VS_P_miss_goodN_Step1 = new TH2D("M_miss_VS_P_miss_goodN_Step1", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_M_miss_VS_P_miss_badN_Step1 = new TH2D("M_miss_VS_P_miss_badN_Step1", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_goodN_Step1 = new TH2D("dpp_VS_Edep_goodN_Step1", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_badN_Step1 = new TH2D("dpp_VS_Edep_badN_Step1", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_badN_Step1);

    TH2D *h_pnRes_theta_n_miss_Step1 = new TH2D("pnRes_theta_n_miss_Step1", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs. #theta_{n,miss};|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss};#theta_{n,miss} [#circ]", 50, -3.0, 1.0, 90, 0, 180);
    hist_list_2_A.push_back(h_pnRes_theta_n_miss_Step1);
    ...
    TH2D *h_M_miss_VS_P_miss_goodN_Step2 = new TH2D("M_miss_VS_P_miss_goodN_Step2", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_M_miss_VS_P_miss_badN_Step2 = new TH2D("M_miss_VS_P_miss_badN_Step2", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_goodN_Step2 = new TH2D("dpp_VS_Edep_goodN_Step2", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_badN_Step2 = new TH2D("dpp_VS_Edep_badN_Step2", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_badN_Step2);

    TH2D *h_pnRes_theta_n_miss_Step2 = new TH2D("pnRes_theta_n_miss_Step2", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs. #theta_{n,miss};|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss};#theta_{n,miss} [#circ]", 50, -3.0, 1.0, 90, 0, 180);
    hist_list_2_A.push_back(h_pnRes_theta_n_miss_Step2);
    ...
    TH2D *h_M_miss_VS_P_miss_goodN_Step3 = new TH2D("M_miss_VS_P_miss_goodN_Step3", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_M_miss_VS_P_miss_badN_Step3 = new TH2D("M_miss_VS_P_miss_badN_Step3", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_goodN_Step3 = new TH2D("dpp_VS_Edep_goodN_Step3", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_badN_Step3 = new TH2D("dpp_VS_Edep_badN_Step3", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_badN_Step3);

    TH2D *h_pnRes_theta_n_miss_Step3 = new TH2D("pnRes_theta_n_miss_Step3", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs. #theta_{n,miss};|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss};#theta_{n,miss} [#circ]", 50, -3.0, 1.0, 90, 0, 180);
    hist_list_2_A.push_back(h_pnRes_theta_n_miss_Step3);
    ...
    TH2D *h_M_miss_VS_P_miss_goodN_Step4 = new TH2D("M_miss_VS_P_miss_goodN_Step4", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_M_miss_VS_P_miss_badN_Step4 = new TH2D("M_miss_VS_P_miss_badN_Step4", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_goodN_Step4 = new TH2D("dpp_VS_Edep_goodN_Step4", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_badN_Step4 = new TH2D("dpp_VS_Edep_badN_Step4", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_badN_Step4);

    TH2D *h_pnRes_theta_n_miss_Step4 = new TH2D("pnRes_theta_n_miss_Step4", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs. #theta_{n,miss};|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss};#theta_{n,miss} [#circ]", 50, -3.0, 1.0, 90, 0, 180);
    hist_list_2_A.push_back(h_pnRes_theta_n_miss_Step4);
    ...
    TH2D *h_M_miss_VS_P_miss_goodN_Step5 = new TH2D("M_miss_VS_P_miss_goodN_Step5", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_M_miss_VS_P_miss_badN_Step5 = new TH2D("M_miss_VS_P_miss_badN_Step5", "Missing Mass vs Missing Momentum;P_{miss} [GeV/c];M_{miss} [GeV/c^{2}]", 50, 0, 1.25, 50, 0, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_goodN_Step5 = new TH2D("dpp_VS_Edep_goodN_Step5", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    ...
    TH2D *h_dpp_VS_Edep_badN_Step5 = new TH2D("dpp_VS_Edep_badN_Step5", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs Neutron Energy Deposition;E_{dep} [MeV];|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss}", 50, 0, 100, 50, -1.5, 1.5);
    hist_list_2_A.push_back(h_dpp_VS_Edep_badN_Step5);

    TH2D *h_pnRes_theta_n_miss_Step5 = new TH2D("pnRes_theta_n_miss_Step5", "|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss} vs. #theta_{n,miss};|#vec{P}_{miss}-#vec{P}_{n}|/P_{miss};#theta_{n,miss} [#circ]", 50, -3.0, 1.0, 90, 0, 180);
    hist_list_2_A.push_back(h_pnRes_theta_n_miss_Step5);
...
#pragma region /* Neutrons */
            ...
            for (int itr1 = 0; itr1 < AllParticles.size(); itr1++)
            {
                ...
                double Edep_CND = AllParticles[itr1]->sci(CND1)->getEnergy() + AllParticles[itr1]->sci(CND2)->getEnergy() + AllParticles[itr1]->sci(CND3)->getEnergy();
                ...
                h_theta_P_n_P_p_epnCD->Fill(P_p.Mag(), P_p.Angle(P_n) * 180. / M_PI, weight);
...
#pragma region /* Step Zero - start */
                ...
                h_pnRes_theta_n_miss_Step0->Fill(dpp, theta_n_miss, weight);
