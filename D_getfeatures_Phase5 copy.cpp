...
#pragma region /* Andrew's histograms - start */
    ...
    TH1D *h_P_n_minus_P_miss_goodN_Step0_epnCD = new TH1D("P_n_minus_P_miss_goodN_Step0_epnCD", "P_{n}-P_{miss} [GeV/c];P_{n}-P_{miss} [GeV/c];Counts", 50, -1.5, 1.5);
    ...
    TH1D *h_P_n_minus_P_miss_badN_Step0_epnCD = new TH1D("P_n_minus_P_miss_badN_Step0_epnCD", "P_{n}-P_{miss} [GeV/c];P_{n}-P_{miss} [GeV/c];Counts", 50, -1.5, 1.5);
    ...
    TH1D *h_P_n_minus_P_miss_goodN_Step0_epnFD = new TH1D("P_n_minus_P_miss_goodN_Step0_epnFD", "P_{n}-P_{miss} [GeV/c];P_{n}-P_{miss} [GeV/c];Counts", 50, -1.5, 1.5);
    ...
    TH1D *h_P_n_minus_P_miss_badN_Step0_epnFD = new TH1D("P_n_minus_P_miss_badN_Step0_epnFD", "P_{n}-P_{miss} [GeV/c];P_{n}-P_{miss} [GeV/c];Counts", 50, -1.5, 1.5);
    ...
    TH2D *h_P_n_VS_P_miss_goodN_Step0_epnCD = new TH2D("P_n_VS_P_miss_goodN_Step0_epnCD", "P_{n} vs P_{miss} [GeV/c];P_{n} [GeV/c];P_{miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    ...
    TH2D *h_P_n_VS_P_miss_badN_Step0_epnCD = new TH2D("P_n_VS_P_miss_badN_Step0_epnCD", "P_{n} vs P_{miss} [GeV/c];P_{n} [GeV/c];P_{miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    ...
    TH2D *h_P_n_VS_P_miss_goodN_Step0_epnFD = new TH2D("P_n_VS_P_miss_goodN_Step0_epnFD", "P_{n} vs P_{miss} [GeV/c];P_{n} [GeV/c];P_{miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    ...
    TH2D *h_P_n_VS_P_miss_badN_Step0_epnFD = new TH2D("P_n_VS_P_miss_badN_Step0_epnFD", "P_{n} vs P_{miss} [GeV/c];P_{n} [GeV/c];P_{miss} [GeV/c]", 50, 0, 1.5, 50, 0, 1.5);
    ...
    TH2D *h_theta_P_n_P_p_goodN_Step0_epnCD = new TH2D("theta_P_n_P_p_goodN_Step0_epnCD", "#theta_{p,n} vs P_{p};P_{p} [GeV/c];#theta_{p,n} [#circ]", 50, 0, 1.5, 50, 0, 180);
    hist_list_2_A.push_back(h_theta_P_n_P_p_goodN_Step0_epnCD);
    TH2D *h_theta_P_n_P_p_badN_Step0_epnCD = new TH2D("theta_P_n_P_p_badN_Step0_epnCD", "#theta_{p,n} vs P_{p};P_{p} [GeV/c];#theta_{p,n} [#circ]", 50, 0, 1.5, 50, 0, 180);
    hist_list_2_A.push_back(h_theta_P_n_P_p_badN_Step0_epnCD);

    TH2D *h_theta_P_n_P_p_goodN_Step0_epnFD = new TH2D("theta_P_n_P_p_goodN_Step0_epnFD", "#theta_{p,n} vs P_{p};P_{p} [GeV/c];#theta_{p,n} [#circ]", 50, 0, 1.5, 50, 0, 180);
    hist_list_2_A.push_back(h_theta_P_n_P_p_goodN_Step0_epnFD);
    TH2D *h_theta_P_n_P_p_badN_Step0_epnFD = new TH2D("theta_P_n_P_p_badN_Step0_epnFD", "#theta_{p,n} vs P_{p};P_{p} [GeV/c];#theta_{p,n} [#circ]", 50, 0, 1.5, 50, 0, 180);
    hist_list_2_A.push_back(h_theta_P_n_P_p_badN_Step0_epnFD);
    ...
    TH2D *h_E_miss_VS_ToF_goodN_Step0_epnFD = new TH2D("E_miss_VS_ToF_goodN_Step0_epnFD", "E_{miss} vs ToF;ToF [ns];E_{miss} [GeV]", 50, 0, 20, 50, 0.5, 1.5);
    ...
    TH2D *h_E_miss_VS_ToF_badN_Step0_epnFD = new TH2D("E_miss_VS_ToF_badN_Step0_epnFD", "E_{miss} vs ToF;ToF [ns];E_{miss} [GeV]", 50, 0, 20, 50, 0.5, 1.5);
    ...
    TH1D *h_edep_over_edepCTOT_goodN_Step0 = new TH1D("edep_over_edepCTOT_goodN_Step0", "E_{dep,N}/E_{dep,pos};E_{dep,N}/E_{dep,pos};Counts", 100, 0, 5);
    hist_list_1_A.push_back(h_edep_over_edepCTOT_goodN_Step0);
    TH1D *h_edep_over_edepCTOT_badN_Step0 = new TH1D("edep_over_edepCTOT_badN_Step0", "E_{dep,N}/E_{dep,pos};E_{dep,N}/E_{dep,pos};Counts", 100, 0, 5);
    hist_list_1_A.push_back(h_edep_over_edepCTOT_badN_Step0);
    ...
    TH1D *h_sdiff_pos_goodN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_goodN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector (Layer Difference = %d)", k - 3);
        h_sdiff_pos_goodN_Step0_layer[k] = new TH1D(temp_name_A, temp_title_A, 24, -11.5, 12.5);
        hist_list_1_A.push_back(h_sdiff_pos_goodN_Step0_layer[k]);
    }

    TH1D *h_sdiff_pos_badN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_badN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector (Layer Difference = %d)", k - 3);
        h_sdiff_pos_badN_Step0_layer[k] = new TH1D(temp_name_A, temp_title_A, 24, -11.5, 12.5);
        hist_list_1_A.push_back(h_sdiff_pos_badN_Step0_layer[k]);
    }

    TH2D *h_sdiff_pos_mom_goodN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_mom_goodN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector vs. Momentum Proton (Layer Difference = %d)", k - 3);
        h_sdiff_pos_mom_goodN_Step0_layer[k] = new TH2D(temp_name_A, temp_title_A, 24, -11.5, 12.5, 50, 0, 4);
        hist_list_2_A.push_back(h_sdiff_pos_mom_goodN_Step0_layer[k]);
    }

    TH2D *h_sdiff_pos_mom_badN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_mom_badN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector vs. Momentum Proton (Layer Difference = %d)", k - 3);
        h_sdiff_pos_mom_badN_Step0_layer[k] = new TH2D(temp_name_A, temp_title_A, 24, -11.5, 12.5, 50, 0, 4);
        hist_list_2_A.push_back(h_sdiff_pos_mom_badN_Step0_layer[k]);
    }

    TH2D *h_sdiff_pos_z_goodN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_z_goodN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector vs. Z (Layer Difference = %d)", k - 3);
        h_sdiff_pos_z_goodN_Step0_layer[k] = new TH2D(temp_name_A, temp_title_A, 24, -11.5, 12.5, 50, -40.0, 40.0);
        hist_list_2_A.push_back(h_sdiff_pos_z_goodN_Step0_layer[k]);
    }

    TH2D *h_sdiff_pos_z_badN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_z_badN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector vs. Z (Layer Difference = %d)", k - 3);
        h_sdiff_pos_z_badN_Step0_layer[k] = new TH2D(temp_name_A, temp_title_A, 24, -11.5, 12.5, 50, -40.0, 40.0);
        hist_list_2_A.push_back(h_sdiff_pos_z_badN_Step0_layer[k]);
    }

    TH2D *h_sdiff_pos_diff_ToFc_z_goodN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_diff_ToFc_z_goodN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector vs. ToF*c-z (Layer Difference = %d)", k - 3);
        h_sdiff_pos_diff_ToFc_z_goodN_Step0_layer[k] = new TH2D(temp_name_A, temp_title_A, 24, -11.5, 12.5, 50, 0, 300);
        hist_list_2_A.push_back(h_sdiff_pos_diff_ToFc_z_goodN_Step0_layer[k]);
    }

    TH2D *h_sdiff_pos_diff_ToFc_z_badN_Step0_layer[7];

    for (int k = 0; k < 7; k++)
    {
        sprintf(temp_name_A, "sdiff_pos_diff_ToFc_z_badN_Step0_layer_%d", k - 3);
        sprintf(temp_title_A, "Nuetral Sector minus +Charge Particle Sector vs. ToF*c-z (Layer Difference = %d)", k - 3);
        h_sdiff_pos_diff_ToFc_z_badN_Step0_layer[k] = new TH2D(temp_name_A, temp_title_A, 24, -11.5, 12.5, 50, 0, 300);
        hist_list_2_A.push_back(h_sdiff_pos_diff_ToFc_z_badN_Step0_layer[k]);
    }

    TH2D *h_diff_ToFc_z_Edep_noNear_goodN_Step0 = new TH2D("diff_ToFc_z_Edep_noNear_goodN_Step0", "ToF*c - z vs. E_{dep} of CND Neutrons with no Nearby Tracks;ToF*c-z [cm];E_{dep} [MeV]", 50, 0, 300, 50, 0, 100);
    hist_list_2_A.push_back(h_diff_ToFc_z_Edep_noNear_goodN_Step0);
    TH2D *h_diff_ToFc_z_Edep_noNear_badN_Step0 = new TH2D("diff_ToFc_z_Edep_noNear_badN_Step0", "ToF*c - z vs. E_{dep} of CND Neutrons with no Nearby Tracks;ToF*c-z [cm];E_{dep} [MeV]", 50, 0, 300, 50, 0, 100);
    hist_list_2_A.push_back(h_diff_ToFc_z_Edep_noNear_badN_Step0);

    TH2D *h_diff_ToFc_z_Edep_yesNear_goodN_Step0 = new TH2D("diff_ToFc_z_Edep_yesNear_goodN_Step0", "ToF*c - z vs. E_{dep} of CND Neutrons with no Nearby Tracks;ToF*c-z [cm];E_{dep} [MeV]", 50, 0, 300, 50, 0, 100);
    hist_list_2_A.push_back(h_diff_ToFc_z_Edep_yesNear_goodN_Step0);
    TH2D *h_diff_ToFc_z_Edep_yesNear_badN_Step0 = new TH2D("diff_ToFc_z_Edep_yesNear_badN_Step0", "ToF*c - z vs. E_{dep} of CND Neutrons with no Nearby Tracks;ToF*c-z [cm];E_{dep} [MeV]", 50, 0, 300, 50, 0, 100);
    hist_list_2_A.push_back(h_diff_ToFc_z_Edep_yesNear_badN_Step0);
    ...
    TH1D *h_beta_goodN_Step1 = new TH1D("beta_goodN_Step1", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_goodN_Step1);
    TH1D *h_beta_badN_Step1 = new TH1D("beta_badN_Step1", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_badN_Step1);
    ...
    TH1D *h_beta_goodN_Step2 = new TH1D("beta_goodN_Step2", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_goodN_Step2);
    TH1D *h_beta_badN_Step2 = new TH1D("beta_badN_Step2", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_badN_Step2);
    ...
    TH1D *h_beta_goodN_Step3 = new TH1D("beta_goodN_Step3", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_goodN_Step3);
    TH1D *h_beta_badN_Step3 = new TH1D("beta_badN_Step3", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_badN_Step3);
    ...
    TH1D *h_beta_goodN_Step4 = new TH1D("beta_goodN_Step4", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_goodN_Step4);
    TH1D *h_beta_badN_Step4 = new TH1D("beta_badN_Step4", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_badN_Step4);
    ...
    TH1D *h_beta_goodN_Step5 = new TH1D("beta_goodN_Step5", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_goodN_Step5);
    TH1D *h_beta_badN_Step5 = new TH1D("beta_badN_Step5", "#beta of CND Neutrons;#beta;Counts", 50, 0, 1.1);
    hist_list_1_A.push_back(h_beta_badN_Step5);
...
#pragma region /* Neutrons */
            ...
            for (int itr1 = 0; itr1 < AllParticles.size(); itr1++)
            {
                ...
                if (pInCD)
                {
                    ...
                    h_ToF_VS_ToF_epnCD->Fill(ToF, ToF, weight);
                ...
                else if (pInFD)
                {
                    ...
                    h_theta_P_n_P_p_epnFD->Fill(P_p.Mag(), P_p.Angle(P_n) * 180. / M_PI, weight);
                    ...
                    h_ToF_VS_ToF_epnFD->Fill(ToF, ToF, weight);
