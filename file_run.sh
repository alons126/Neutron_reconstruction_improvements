...
setenv OUTDIR Output_data_P8_run4_full_Step2WithOnlydToFNeutNearCuts
# setenv OUTDIR Output_data_P8_run4_full_Step2WithdToFandPhiNeutNearCuts_OR
...
# clas12root -l -q 'ManualVeto_Phase8.cpp("${OUTDIR}", "${OUTDIR}/Erin_plots.pdf", 5.98636, true, "${OUTDIR}/Erin_plots.root", "${OUTDIR}/Erin_plots.txt", "/cache/clas12/rg-m/production/pass1/6gev/D/dst/recon/015449/*.hipo", "${OUTDIR}/Andrew_plots.pdf")'
# # ----------------------------------------------------------------------------------
