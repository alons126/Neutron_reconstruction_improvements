...
#ifndef VETOCUTSSETTINGS_H
#define VETOCUTSSETTINGS_H
...
struct {  // Structure declaration
    ...
    const bool Apply_CTOF_veto = false;

    // NOTE: Step 0 cuts - disabled following RG-M meeting (29-01-25) and Adi meeting (02-02-25)
    const bool Apply_Step0_Cuts = true;

    // Cut values ---------------------------------------------------------------------------------------------------------------------------------------------------------------------

    const int Num_of_e_cut = 1;
    const int Num_of_p_cut = 1;
