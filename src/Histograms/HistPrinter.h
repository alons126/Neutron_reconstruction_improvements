                    ...
                    if (Constraint1 == "")
                    {
                        ...
                        if (Constraint1 == "" || Constraint1 == "CD")
                        {
                            ...
                            const char *table_epCDn[7][6] = {
                                ...
                                {"Step 0", to_string(Num_of_goodN_Step0_epCDn + Num_of_badN_Step0_epCDn), to_string(Num_of_goodN_Step0_epCDn), to_string(Num_of_badN_Step0_epCDn), "--", "--"},
                                {"Step 1", to_string(Num_of_goodN_Step1_epCDn + Num_of_badN_Step1_epCDn), to_string(Num_of_goodN_Step1_epCDn), to_string(Num_of_badN_Step1_epCDn), to_string_with_precision(1 - (Num_of_goodN_Step1_epCDn / Num_of_goodN_Step0_epCDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step1_epCDn / Num_of_goodN_Step0_epCDn), 2)},
                                {"Step 2", to_string(Num_of_goodN_Step2_epCDn + Num_of_badN_Step2_epCDn), to_string(Num_of_goodN_Step2_epCDn), to_string(Num_of_badN_Step2_epCDn), to_string_with_precision(1 - (Num_of_goodN_Step2_epCDn / Num_of_goodN_Step1_epCDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step2_epCDn / Num_of_goodN_Step1_epCDn), 2)},
                                {"Step 3", to_string(Num_of_goodN_Step3_epCDn + Num_of_badN_Step3_epCDn), to_string(Num_of_goodN_Step3_epCDn), to_string(Num_of_badN_Step3_epCDn), to_string_with_precision(1 - (Num_of_goodN_Step3_epCDn / Num_of_goodN_Step2_epCDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step3_epCDn / Num_of_goodN_Step2_epCDn), 2)},
                                {"Step 4", to_string(Num_of_goodN_Step4_epCDn + Num_of_badN_Step4_epCDn), to_string(Num_of_goodN_Step4_epCDn), to_string(Num_of_badN_Step4_epCDn), to_string_with_precision(1 - (Num_of_goodN_Step4_epCDn / Num_of_goodN_Step3_epCDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step4_epCDn / Num_of_goodN_Step3_epCDn), 2)},
                                {"Step 5", to_string(Num_of_goodN_Step5_epCDn + Num_of_badN_Step5_epCDn), to_string(Num_of_goodN_Step5_epCDn), to_string(Num_of_badN_Step5_epCDn), to_string_with_precision(1 - (Num_of_goodN_Step5_epCDn / Num_of_goodN_Step4_epCDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step5_epCDn / Num_of_goodN_Step4_epCDn), 2)}};
                        ...
                        if (Constraint1 == "" || Constraint1 == "FD")
                        {
                            ...
                            const char *table_epFDn[7][6] = {
                                {"", "#(allN)", "#(goodN)", "#(badN)", "%(goodN) lost", "%(badN) lost"},
                                {"Step 0", to_string(Num_of_goodN_Step0_epFDn + Num_of_badN_Step0_epFDn), to_string(Num_of_goodN_Step0_epFDn), to_string(Num_of_badN_Step0_epFDn), "--", "--"},
                                {"Step 1", to_string(Num_of_goodN_Step1_epFDn + Num_of_badN_Step1_epFDn), to_string(Num_of_goodN_Step1_epFDn), to_string(Num_of_badN_Step1_epFDn), to_string_with_precision(1 - (Num_of_goodN_Step1_epFDn / Num_of_goodN_Step0_epFDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step1_epFDn / Num_of_goodN_Step0_epFDn), 2)},
                                {"Step 2", to_string(Num_of_goodN_Step2_epFDn + Num_of_badN_Step2_epFDn), to_string(Num_of_goodN_Step2_epFDn), to_string(Num_of_badN_Step2_epFDn), to_string_with_precision(1 - (Num_of_goodN_Step2_epFDn / Num_of_goodN_Step1_epFDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step2_epFDn / Num_of_goodN_Step1_epFDn), 2)},
                                {"Step 3", to_string(Num_of_goodN_Step3_epFDn + Num_of_badN_Step3_epFDn), to_string(Num_of_goodN_Step3_epFDn), to_string(Num_of_badN_Step3_epFDn), to_string_with_precision(1 - (Num_of_goodN_Step3_epFDn / Num_of_goodN_Step2_epFDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step3_epFDn / Num_of_goodN_Step2_epFDn), 2)},
                                {"Step 4", to_string(Num_of_goodN_Step4_epFDn + Num_of_badN_Step4_epFDn), to_string(Num_of_goodN_Step4_epFDn), to_string(Num_of_badN_Step4_epFDn), to_string_with_precision(1 - (Num_of_goodN_Step4_epFDn / Num_of_goodN_Step3_epFDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step4_epFDn / Num_of_goodN_Step3_epFDn), 2)},
                                {"Step 5", to_string(Num_of_goodN_Step5_epFDn + Num_of_badN_Step5_epFDn), to_string(Num_of_goodN_Step5_epFDn), to_string(Num_of_badN_Step5_epFDn), to_string_with_precision(1 - (Num_of_goodN_Step5_epFDn / Num_of_goodN_Step4_epFDn), 2), to_string_with_precision(1 - (Num_of_goodN_Step5_epFDn / Num_of_goodN_Step4_epFDn), 2)}};
