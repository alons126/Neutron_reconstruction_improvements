            ...
            else if (findSubstring(TempHistName, "Step"))
            {
                ...
                if (FirstStepPlot[Step] == true)
                {
                    ...
                    if (Constraint1 == "" || Constraint1 == "CD")
                    {
                        ...
                        string Num_of_allN_bfSteps_epCDn_str = to_string_with_precision(Num_of_goodN_bfSteps_epCDn + Num_of_badN_bfSteps_epCDn, 0);
                        ...
                        string Num_of_allN_Step0_epCDn_str = to_string_with_precision(Num_of_goodN_Step0_epCDn + Num_of_badN_Step0_epCDn, 0);
                        ...
                        string Num_of_allN_Step1_epCDn_str = to_string_with_precision(Num_of_goodN_Step1_epCDn + Num_of_badN_Step1_epCDn, 0);
                        ...
                        string Num_of_allN_Step2_epCDn_str = to_string_with_precision(Num_of_goodN_Step2_epCDn + Num_of_badN_Step2_epCDn, 0);
                        ...
                        string Num_of_allN_Step3_epCDn_str = to_string_with_precision(Num_of_goodN_Step3_epCDn + Num_of_badN_Step3_epCDn, 0);
                        ...
                        string Num_of_allN_Step4_epCDn_str = to_string_with_precision(Num_of_goodN_Step4_epCDn + Num_of_badN_Step4_epCDn, 0);
                        ...
                        string Num_of_allN_Step5_epCDn_str = to_string_with_precision(Num_of_goodN_Step5_epCDn + Num_of_badN_Step5_epCDn, 0);
