                    ...
                    if (Constraint1 == "")
                    {
                        ...
                        if (Constraint1 == "" || Constraint1 == "CD")
                        {
                            ...
                            const char *table_epCDn[7][6] = {
                                ...
                                {"Step 1", to_string(Num_of_goodN_Step1_epCDn + Num_of_badN_Step1_epCDn).c_str(), to_string(Num_of_goodN_Step1_epCDn).c_str(), to_string(Num_of_badN_Step1_epCDn).c_str(), to_string_with_precision(1 - (Num_of_goodN_Step1_epCDn / Num_of_goodN_Step0_epCDn).c_str(), 2), to_string_with_precision(1 - (Num_of_goodN_Step1_epCDn / Num_of_goodN_Step0_epCDn).c_str(), 2)},
                                {"Step 2", to_string(Num_of_goodN_Step2_epCDn + Num_of_badN_Step2_epCDn).c_str(), to_string(Num_of_goodN_Step2_epCDn).c_str(), to_string(Num_of_badN_Step2_epCDn).c_str(), to_string_with_precision(1 - (Num_of_goodN_Step2_epCDn / Num_of_goodN_Step1_epCDn).c_str(), 2), to_string_with_precision(1 - (Num_of_goodN_Step2_epCDn / Num_of_goodN_Step1_epCDn).c_str(), 2)},
                                {"Step 3", to_string(Num_of_goodN_Step3_epCDn + Num_of_badN_Step3_epCDn).c_str(), to_string(Num_of_goodN_Step3_epCDn).c_str(), to_string(Num_of_badN_Step3_epCDn).c_str(), to_string_with_precision(1 - (Num_of_goodN_Step3_epCDn / Num_of_goodN_Step2_epCDn).c_str(), 2), to_string_with_precision(1 - (Num_of_goodN_Step3_epCDn / Num_of_goodN_Step2_epCDn).c_str(), 2)},
                                {"Step 4", to_string(Num_of_goodN_Step4_epCDn + Num_of_badN_Step4_epCDn).c_str(), to_string(Num_of_goodN_Step4_epCDn).c_str(), to_string(Num_of_badN_Step4_epCDn).c_str(), to_string_with_precision(1 - (Num_of_goodN_Step4_epCDn / Num_of_goodN_Step3_epCDn).c_str(), 2), to_string_with_precision(1 - (Num_of_goodN_Step4_epCDn / Num_of_goodN_Step3_epCDn).c_str(), 2)},
                                {"Step 5", to_string(Num_of_goodN_Step5_epCDn + Num_of_badN_Step5_epCDn).c_str(), to_string(Num_of_goodN_Step5_epCDn).c_str(), to_string(Num_of_badN_Step5_epCDn).c_str(), to_string_with_precision(1 - (Num_of_goodN_Step5_epCDn / Num_of_goodN_Step4_epCDn).c_str(), 2), to_string_with_precision(1 - (Num_of_goodN_Step5_epCDn / Num_of_goodN_Step4_epCDn).c_str(), 2)}};
