...
void VetoHistograms::UpdateBmissCHistograms(bool pInCD, bool pInFD, TVector3 P_miss_3v, double E_p, double E_miss, double M_miss, double xB, double weight) {
    if (pInCD) {
...
void VetoHistograms::UpdateAmissCHistograms(bool pInCD, bool pInFD, TVector3 P_miss_3v, double E_p, double E_miss, double M_miss, double xB, double weight) {
    if (pInCD) {
...
void VetoHistograms::UpdatePreStepHistograms(bool pInCD, bool pInFD, bool isGN, bool isBN, TVector3 P_q_3v, double Q2, TVector3 P_p_3v, TVector3 P_miss_3v, TVector3 P_n_3v, double E_p, double E_miss,
    ...
    if (pInCD) {
        ...
        h_q_epCDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_epCDn->Fill(Q2, weight);

        h_P_p_epCDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_epCDn->Fill(P_p_3v.Mag(), beta_p, weight);
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_epCDn->Fill(theta_n_miss, weight); }
        ...
        h_P_n_VS_M_miss_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
        h_theta_n_VS_M_miss_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
        h_phi_n_VS_M_miss_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
        h_P_miss_VS_M_miss_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
        h_theta_miss_VS_M_miss_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
        h_phi_miss_VS_M_miss_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
        h_dpp_VS_M_miss_epCDn->Fill(dpp, M_miss, weight);
        h_theta_n_miss_VS_M_miss_epCDn->Fill(theta_n_miss, M_miss, weight);
        h_beta_n_VS_M_miss_epCDn->Fill(beta, M_miss, weight);
        h_E_p_VS_M_miss_epCDn->Fill(E_p, M_miss, weight);
        h_E_miss_VS_M_miss_epCDn->Fill(E_miss, M_miss, weight);
        h_path_VS_M_miss_epCDn->Fill(path * 100, M_miss, weight);
        h_ToF_VS_M_miss_epCDn->Fill(ToF, M_miss, weight);
        h_nSector_VS_M_miss_epCDn->Fill(nSector, M_miss, weight);
        h_Edep_CND_VS_M_miss_epCDn->Fill(Edep_CND, M_miss, weight);
        h_Edep_CND1_VS_M_miss_epCDn->Fill(Edep_CND1, M_miss, weight);
        h_Edep_CND2_VS_M_miss_epCDn->Fill(Edep_CND2, M_miss, weight);
        h_Edep_CND3_VS_M_miss_epCDn->Fill(Edep_CND3, M_miss, weight);

        if (isGN) {
            h_E_p_goodN_epCDn->Fill(E_p, weight);
            h_E_miss_goodN_epCDn->Fill(E_miss, weight);
            h_M_miss_goodN_epCDn->Fill(M_miss, weight);
            h_P_n_VS_M_miss_goodN_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_dpp_VS_M_miss_goodN_epCDn->Fill(dpp, M_miss, weight);
            h_theta_n_miss_VS_M_miss_goodN_epCDn->Fill(theta_n_miss, M_miss, weight);
            h_beta_n_VS_M_miss_goodN_epCDn->Fill(beta, M_miss, weight);
            h_E_p_VS_M_miss_goodN_epCDn->Fill(E_p, M_miss, weight);
            h_E_miss_VS_M_miss_goodN_epCDn->Fill(E_miss, M_miss, weight);
            h_path_VS_M_miss_goodN_epCDn->Fill(path * 100, M_miss, weight);
            h_ToF_VS_M_miss_goodN_epCDn->Fill(ToF, M_miss, weight);
            h_nSector_VS_M_miss_goodN_epCDn->Fill(nSector, M_miss, weight);
            h_Edep_CND_VS_M_miss_goodN_epCDn->Fill(Edep_CND, M_miss, weight);
            h_Edep_CND1_VS_M_miss_goodN_epCDn->Fill(Edep_CND1, M_miss, weight);
            h_Edep_CND2_VS_M_miss_goodN_epCDn->Fill(Edep_CND2, M_miss, weight);
            h_Edep_CND3_VS_M_miss_goodN_epCDn->Fill(Edep_CND3, M_miss, weight);
        } else if (isBN) {
            h_E_p_badN_epCDn->Fill(E_p, weight);
            h_E_miss_badN_epCDn->Fill(E_miss, weight);
            h_M_miss_badN_epCDn->Fill(M_miss, weight);
            h_P_n_VS_M_miss_badN_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_dpp_VS_M_miss_badN_epCDn->Fill(dpp, M_miss, weight);
            h_theta_n_miss_VS_M_miss_badN_epCDn->Fill(theta_n_miss, M_miss, weight);
            h_beta_n_VS_M_miss_badN_epCDn->Fill(beta, M_miss, weight);
            h_E_p_VS_M_miss_badN_epCDn->Fill(E_p, M_miss, weight);
            h_E_miss_VS_M_miss_badN_epCDn->Fill(E_miss, M_miss, weight);
            h_path_VS_M_miss_badN_epCDn->Fill(path * 100, M_miss, weight);
            h_ToF_VS_M_miss_badN_epCDn->Fill(ToF, M_miss, weight);
            h_nSector_VS_M_miss_badN_epCDn->Fill(nSector, M_miss, weight);
            h_Edep_CND_VS_M_miss_badN_epCDn->Fill(Edep_CND, M_miss, weight);
            h_Edep_CND1_VS_M_miss_badN_epCDn->Fill(Edep_CND1, M_miss, weight);
            h_Edep_CND2_VS_M_miss_badN_epCDn->Fill(Edep_CND2, M_miss, weight);
            h_Edep_CND3_VS_M_miss_badN_epCDn->Fill(Edep_CND3, M_miss, weight);
        }
        ...
        h_q_epFDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_epFDn->Fill(Q2, weight);

        h_P_p_epFDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_epFDn->Fill(P_p_3v.Mag(), beta_p, weight);
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_epFDn->Fill(theta_n_miss, weight); }
        ...
        h_P_n_VS_M_miss_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
        h_theta_n_VS_M_miss_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
        h_phi_n_VS_M_miss_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
        h_P_miss_VS_M_miss_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
        h_theta_miss_VS_M_miss_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
        h_phi_miss_VS_M_miss_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
        h_dpp_VS_M_miss_epFDn->Fill(dpp, M_miss, weight);
        h_theta_n_miss_VS_M_miss_epFDn->Fill(theta_n_miss, M_miss, weight);
        h_beta_n_VS_M_miss_epFDn->Fill(beta, M_miss, weight);
        h_E_p_VS_M_miss_epFDn->Fill(E_p, M_miss, weight);
        h_E_miss_VS_M_miss_epFDn->Fill(E_miss, M_miss, weight);
        h_path_VS_M_miss_epFDn->Fill(path * 100, M_miss, weight);
        h_ToF_VS_M_miss_epFDn->Fill(ToF, M_miss, weight);
        h_nSector_VS_M_miss_epFDn->Fill(nSector, M_miss, weight);
        h_Edep_CND_VS_M_miss_epFDn->Fill(Edep_CND, M_miss, weight);
        h_Edep_CND1_VS_M_miss_epFDn->Fill(Edep_CND1, M_miss, weight);
        h_Edep_CND2_VS_M_miss_epFDn->Fill(Edep_CND2, M_miss, weight);
        h_Edep_CND3_VS_M_miss_epFDn->Fill(Edep_CND3, M_miss, weight);

        if (isGN) {
            h_E_p_goodN_epFDn->Fill(E_p, weight);
            h_E_miss_goodN_epFDn->Fill(E_miss, weight);
            h_M_miss_goodN_epFDn->Fill(M_miss, weight);
            h_P_n_VS_M_miss_goodN_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_dpp_VS_M_miss_goodN_epFDn->Fill(dpp, M_miss, weight);
            h_theta_n_miss_VS_M_miss_goodN_epFDn->Fill(theta_n_miss, M_miss, weight);
            h_beta_n_VS_M_miss_goodN_epFDn->Fill(beta, M_miss, weight);
            h_E_p_VS_M_miss_goodN_epFDn->Fill(E_p, M_miss, weight);
            h_E_miss_VS_M_miss_goodN_epFDn->Fill(E_miss, M_miss, weight);
            h_path_VS_M_miss_goodN_epFDn->Fill(path * 100, M_miss, weight);
            h_ToF_VS_M_miss_goodN_epFDn->Fill(ToF, M_miss, weight);
            h_nSector_VS_M_miss_goodN_epFDn->Fill(nSector, M_miss, weight);
            h_Edep_CND_VS_M_miss_goodN_epFDn->Fill(Edep_CND, M_miss, weight);
            h_Edep_CND1_VS_M_miss_goodN_epFDn->Fill(Edep_CND1, M_miss, weight);
            h_Edep_CND2_VS_M_miss_goodN_epFDn->Fill(Edep_CND2, M_miss, weight);
            h_Edep_CND3_VS_M_miss_goodN_epFDn->Fill(Edep_CND3, M_miss, weight);
        } else if (isBN) {
            h_E_p_badN_epFDn->Fill(E_p, weight);
            h_E_miss_badN_epFDn->Fill(E_miss, weight);
            h_M_miss_badN_epFDn->Fill(M_miss, weight);
            h_P_n_VS_M_miss_badN_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_dpp_VS_M_miss_badN_epFDn->Fill(dpp, M_miss, weight);
            h_theta_n_miss_VS_M_miss_badN_epFDn->Fill(theta_n_miss, M_miss, weight);
            h_beta_n_VS_M_miss_badN_epFDn->Fill(beta, M_miss, weight);
            h_E_p_VS_M_miss_badN_epFDn->Fill(E_p, M_miss, weight);
            h_E_miss_VS_M_miss_badN_epFDn->Fill(E_miss, M_miss, weight);
            h_path_VS_M_miss_badN_epFDn->Fill(path * 100, M_miss, weight);
            h_ToF_VS_M_miss_badN_epFDn->Fill(ToF, M_miss, weight);
            h_nSector_VS_M_miss_badN_epFDn->Fill(nSector, M_miss, weight);
            h_Edep_CND_VS_M_miss_badN_epFDn->Fill(Edep_CND, M_miss, weight);
            h_Edep_CND1_VS_M_miss_badN_epFDn->Fill(Edep_CND1, M_miss, weight);
            h_Edep_CND2_VS_M_miss_badN_epFDn->Fill(Edep_CND2, M_miss, weight);
            h_Edep_CND3_VS_M_miss_badN_epFDn->Fill(Edep_CND3, M_miss, weight);
        }
...
void VetoHistograms::UpdateStep0Histograms(bool pInCD, bool pInFD, bool isGN, bool isBN, TVector3 P_q_3v, double Q2, TVector3 P_p_3v, TVector3 P_miss_3v, TVector3 P_n_3v, double E_p, double E_miss,
                                           double M_miss, double xB, double dpp, double theta_n_miss, double Edep_CND, double Edep_CND1, double Edep_CND2, double Edep_CND3, double Edep_CTOF,
                                           double nSector, double Size_CND1, double Size_CND2, double Size_CND3, double LayerMult_CND1, double LayerMult_CND2, double LayerMult_CND3, double beta,
                                           double beta_p, double path, double ToF, double weight) {
    if (pInCD) {
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_Step0_epCDn->Fill(theta_n_miss, weight); }
        ...
        h_q_Step0_epCDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_Step0_epCDn->Fill(Q2, weight);

        h_P_p_Step0_epCDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_Step0_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_Step0_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_Step0_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_Step0_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_Step0_epCDn->Fill(P_p_3v.Mag(), beta_p, weight);
        ...
        if (isGN) {
            ...
            h_P_n_VS_M_miss_goodN_Step0_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_Step0_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_Step0_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_Step0_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_Step0_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_Step0_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_goodN_Step0_epCDn->Fill(xB, M_miss, weight);
            ...
            h_P_n_VS_M_miss_badN_Step0_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_Step0_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_Step0_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_Step0_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_Step0_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_Step0_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_badN_Step0_epCDn->Fill(xB, M_miss, weight);
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_Step0_epFDn->Fill(theta_n_miss, weight); }
        ...
        h_q_Step0_epFDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_Step0_epFDn->Fill(Q2, weight);

        h_P_p_Step0_epFDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_Step0_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_Step0_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_Step0_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_Step0_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_Step0_epFDn->Fill(P_p_3v.Mag(), beta_p, weight);
        ...
        if (isGN) {
            ...
            h_P_n_VS_M_miss_goodN_Step0_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_Step0_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_Step0_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_Step0_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_Step0_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_Step0_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_goodN_Step0_epFDn->Fill(xB, M_miss, weight);
            ...
            h_P_n_VS_M_miss_badN_Step0_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_Step0_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_Step0_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_Step0_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_Step0_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_Step0_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_badN_Step0_epFDn->Fill(xB, M_miss, weight);
...
void VetoHistograms::UpdateStep1Histograms(bool pInCD, bool pInFD, bool isGN, bool isBN, TVector3 P_q_3v, double Q2, TVector3 P_p_3v, TVector3 P_miss_3v, TVector3 P_n_3v, double E_p, double E_miss,
                                           double M_miss, double xB, double dpp, double theta_n_miss, double Edep_CND, double Edep_CND1, double Edep_CND2, double Edep_CND3, double Edep_CTOF,
                                           double nSector, double Size_CND1, double Size_CND2, double Size_CND3, double LayerMult_CND1, double LayerMult_CND2, double LayerMult_CND3, double beta,
                                           double beta_p, double path, double ToF, double weight) {
    if (pInCD) {
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_Step1_epCDn->Fill(theta_n_miss, weight); }
        ...
        h_q_Step1_epCDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_Step1_epCDn->Fill(Q2, weight);

        h_P_p_Step1_epCDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_Step1_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_Step1_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_Step1_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_Step1_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_Step1_epCDn->Fill(P_p_3v.Mag(), beta_p, weight);
        ...
        if (isGN) {
            ...
            h_P_n_VS_M_miss_goodN_Step1_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_Step1_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_Step1_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_Step1_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_Step1_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_Step1_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_goodN_Step1_epCDn->Fill(xB, M_miss, weight);
            ...
            h_P_n_VS_M_miss_badN_Step1_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_Step1_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_Step1_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_Step1_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_Step1_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_Step1_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_badN_Step1_epCDn->Fill(xB, M_miss, weight);
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_Step1_epFDn->Fill(theta_n_miss, weight); }
        ...
        h_q_Step1_epFDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_Step1_epFDn->Fill(Q2, weight);

        h_P_p_Step1_epFDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_Step1_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_Step1_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_Step1_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_Step1_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_Step1_epFDn->Fill(P_p_3v.Mag(), beta_p, weight);
        ...
        if (isGN) {
            ...
            h_P_n_VS_M_miss_goodN_Step1_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_Step1_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_Step1_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_Step1_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_Step1_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_Step1_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_goodN_Step1_epFDn->Fill(xB, M_miss, weight);
            ...
            h_P_n_VS_M_miss_badN_Step1_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_Step1_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_Step1_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_Step1_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_Step1_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_Step1_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_badN_Step1_epFDn->Fill(xB, M_miss, weight);
...
void VetoHistograms::UpdateStep2prepPosHistograms(bool pInCD, bool pInFD, bool isGN, bool isBN, int ldiff, int sdiff, TVector3 p_C_3v, TVector3 v_hit_3v, TVector3 P_n_3v, double dToF,
    ...
    if (pInCD) {
        ...
        if (isGN) {
            ...
            h_pos_dToF_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_pos_dToF_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_pos_VS_dToF_rel_n_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    } else if (pInFD) {
        if (isGN)  // ldiff + 3 == 0 -> first element in h_sdiff_pos_goodN_Step1_layer
        {
            ...
            h_pos_dToF_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_pos_dToF_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_pos_VS_dToF_rel_n_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    }
}
...
void VetoHistograms::UpdateStep2prepNeutHistograms(bool pInCD, bool pInFD, bool isGN, bool isBN, int ldiff, int sdiff, TVector3 P_neut_3v, TVector3 v_hit_3v, TVector3 P_n_3v, double dToF,
    ...
    if (pInCD) {
        ...
        if (isGN) {
            ...
            h_sdiff_neut_VS_phi_n_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_goodN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_sdiff_neut_VS_phi_n_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_neut_VS_dToF_rel_n_badN_Step2prep_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    } else if (pInFD) {
        if (isGN)  // ldiff + 3 == 0 -> first element in h_sdiff_neut_goodN_Step1_layer
        {
            ...
            h_sdiff_neut_VS_phi_n_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_goodN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_sdiff_neut_VS_phi_n_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_neut_VS_dToF_rel_n_badN_Step2prep_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    }
}
...
void VetoHistograms::UpdateStep2Histograms(bool pInCD, bool pInFD, bool isGN, bool isBN, TVector3 P_q_3v, double Q2, TVector3 P_p_3v, TVector3 P_miss_3v, TVector3 P_n_3v, double E_p, double E_miss,
    ...
    if (pInCD) {
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_Step2_epCDn->Fill(theta_n_miss, weight); }
        ...
        h_q_Step2_epCDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_Step2_epCDn->Fill(Q2, weight);

        h_P_p_Step2_epCDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_Step2_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_Step2_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_Step2_epCDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_Step2_epCDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_Step2_epCDn->Fill(P_p_3v.Mag(), beta_p, weight);

        if (isGN) {
            h_pos_theta_n_goodN_Step2_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, weight);
            h_pos_phi_n_goodN_Step2_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, weight);
            ...
            h_P_n_VS_M_miss_goodN_Step2_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_Step2_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_Step2_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_Step2_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_Step2_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_Step2_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_goodN_Step2_epCDn->Fill(xB, M_miss, weight);

            h_beta_n_goodN_Step2_epCDn->Fill(beta, weight);
        } else if (isBN) {
            h_pos_theta_n_badN_Step2_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, weight);
            h_pos_phi_n_badN_Step2_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, weight);
            ...
            h_P_n_VS_M_miss_badN_Step2_epCDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_Step2_epCDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_Step2_epCDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_Step2_epCDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_Step2_epCDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_Step2_epCDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_badN_Step2_epCDn->Fill(xB, M_miss, weight);
        ...
        if (fabs(dpp) < 0.3) { h_theta_n_miss_allN_for_dpp_m03to03_Step2_epFDn->Fill(theta_n_miss, weight); }
        ...
        h_q_Step2_epFDn->Fill(P_q_3v.Mag(), weight);
        h_Q2_Step2_epFDn->Fill(Q2, weight);

        h_P_p_Step2_epFDn->Fill(P_p_3v.Mag(), weight);
        h_theta_p_Step2_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, weight);
        h_phi_p_Step2_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, weight);
        h_theta_p_VS_phi_p_Step2_epFDn->Fill(P_p_3v.Phi() * 180. / M_PI, P_p_3v.Theta() * 180. / M_PI, weight);
        h_theta_p_VS_beta_p_Step2_epFDn->Fill(P_p_3v.Theta() * 180. / M_PI, beta_p, weight);
        h_P_p_VS_beta_p_Step2_epFDn->Fill(P_p_3v.Mag(), beta_p, weight);

        if (isGN) {
            h_pos_theta_n_goodN_Step2_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, weight);
            h_pos_phi_n_goodN_Step2_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, weight);
            ...
            h_P_n_VS_M_miss_goodN_Step2_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_goodN_Step2_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_goodN_Step2_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_goodN_Step2_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_goodN_Step2_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_goodN_Step2_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_goodN_Step2_epFDn->Fill(xB, M_miss, weight);

            h_beta_n_goodN_Step2_epFDn->Fill(beta, weight);
        } else if (isBN) {
            h_pos_theta_n_badN_Step2_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, weight);
            h_pos_phi_n_badN_Step2_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, weight);
            ...
            h_P_n_VS_M_miss_badN_Step2_epFDn->Fill(P_n_3v.Mag(), M_miss, weight);
            h_theta_n_VS_M_miss_badN_Step2_epFDn->Fill(P_n_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_n_VS_M_miss_badN_Step2_epFDn->Fill(P_n_3v.Phi() * 180. / M_PI, M_miss, weight);
            h_P_miss_VS_M_miss_badN_Step2_epFDn->Fill(P_miss_3v.Mag(), M_miss, weight);
            h_theta_miss_VS_M_miss_badN_Step2_epFDn->Fill(P_miss_3v.Theta() * 180. / M_PI, M_miss, weight);
            h_phi_miss_VS_M_miss_badN_Step2_epFDn->Fill(P_miss_3v.Phi() * 180. / M_PI, M_miss, weight);
            ...
            h_xB_VS_M_miss_badN_Step2_epFDn->Fill(xB, M_miss, weight);
...
void VetoHistograms::UpdateStep2PosHistograms2(bool pInCD, bool pInFD, bool isGN, bool isBN, int ldiff, int sdiff, TVector3 p_C_3v, TVector3 v_hit_3v, TVector3 P_n_3v, double dToF,
    ...
    if (pInCD) {
        if (isGN)  // ldiff + 3 == 0 -> first element in h_sdiff_pos_goodN_Step1_layer
        {
            ...
            h_pos_dToF_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_pos_dToF_badN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_badN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_pos_VS_dToF_rel_n_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    } else if (pInFD) {
        if (isGN)  // ldiff + 3 == 0 -> first element in h_sdiff_pos_goodN_Step1_layer
        {
            ...
            h_pos_dToF_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_pos_dToF_badN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            ...
            h_sdiff_pos_VS_dToF_rel_pos_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_pos, weight);
            h_pos_dToF_rel_n_badN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_pos_VS_dToF_rel_n_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    }
}
...
void VetoHistograms::UpdateStep2NeutHistograms2(bool pInCD, bool pInFD, bool isGN, bool isBN, int ldiff, int sdiff, TVector3 P_neut_3v, TVector3 v_hit_3v, TVector3 P_n_3v, double dToF,
    ...
    if (pInCD) {
        if (isGN)  // ldiff + 3 == 0 -> first element in h_sdiff_neut_goodN_Step1_layer
        {
            ...
            h_sdiff_neut_VS_phi_n_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_goodN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_sdiff_neut_VS_phi_n_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_badN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_badN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_badN_Step2_layer_epCDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_neut_VS_dToF_rel_n_badN_Step2_layer_epCDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    } else if (pInFD) {
        if (isGN)  // ldiff + 3 == 0 -> first element in h_sdiff_neut_goodN_Step1_layer
        {
            ...
            h_sdiff_neut_VS_phi_n_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_goodN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            ...
            h_sdiff_neut_VS_phi_n_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, P_n_3v.Phi() * 180. / M_PI, weight);
            h_sdiff_neut_VS_ToF_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, ToF, weight);
            h_sdiff_neut_VS_path_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, path * 100, weight);
            h_sdiff_neut_VS_beta_n_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, beta, weight);
            h_sdiff_neut_VS_Edep_CND_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, Edep_CND, weight);
            h_sdiff_neut_VS_theta_n_miss_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, theta_n_miss, weight);
            h_sdiff_neut_VS_dpp_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dpp, weight);

            h_neut_dToF_badN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF, weight);
            h_sdiff_neut_VS_dToF_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF, weight);
            h_dToF_rel_neut_badN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF_rel_neut, weight);
            h_sdiff_neut_VS_dToF_rel_neut_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_neut, weight);
            h_neut_dToF_rel_n_badN_Step2_layer_epFDn[ldiff + 3]->Fill(dToF_rel_n, weight);
            h_sdiff_neut_VS_dToF_rel_n_badN_Step2_layer_epFDn[ldiff + 3]->Fill(sdiff, dToF_rel_n, weight);
        }
    }
}
